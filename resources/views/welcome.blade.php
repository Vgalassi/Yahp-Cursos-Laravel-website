    ...
    <body>
        <div class="container"  style="margin-top: 75px">
            <div class="row">
                ...
                <div class="col-6">
                    <h2 class="mt-5">Conheça a Plataforma de cursos gratuítos mais íncrivel do Brasil</h2>
            ...
            <div class="row">
                <div class="col-3">
                    <div class="card" style="width: 18rem; background-color: #EBF3FE;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title" style="text-align:center;">Front-End</h5>
                ...
                <div class="col-3">
                    <div class="card" style="width: 18rem; background-color: #EBF3FE;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title" style="text-align:center;">Back-End</h5>
                          <p style="margin-bottom: 24px;"class="card-text">Aprenda a linguagem PHP e o framework laravel para desenvolver 
                ...
                <div class="col-3">
                    <div class="card" style="width: 18rem; background-color: #EBF3FE;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title" style="text-align:center;">Databases</h5>
                ...
                <div class="col-3">
                    <div class="card" style="width: 18rem; background-color: #EBF3FE; ">
                        ...
                        <div class="card-body">
                          <h5 class="card-title" style="text-align:center;">Github e Gitflow</h5>
